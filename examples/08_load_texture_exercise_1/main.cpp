...
int main() {
  ...
  Shader ourShader("../examples/08_load_texture_exercise_1/shader/vertex.glsl", "../examples/08_load_texture_exercise_1/shader/fragment.glsl");

  Texture_load texture1("../assets/container.png", 0, GL_LINEAR, GL_LINEAR, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE);
