...
int main() {
  ...
  Shader ourShader("../examples/08_load_texture_exercise_2/shader/vertex.glsl", "../examples/08_load_texture_exercise_2/shader/fragment.glsl");

  Texture_load texture1("../assets/container.png", 0, GL_NEAREST, GL_NEAREST, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE);
  Texture_load texture2("../assets/awesomeface.png", 1, GL_NEAREST, GL_NEAREST, GL_REPEAT, GL_REPEAT);
