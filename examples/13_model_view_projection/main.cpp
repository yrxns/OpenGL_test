...
int main() {
  ...
  Shader ourShader("../examples/13_model_view_projection/shader/vertex.glsl", "../examples/13_model_view_projection/shader/fragment.glsl");
...
/*******************************************************************/
    ...
    projection = glm::perspective(glm::radians(45.0f), (float)app->mWidth / (float)app->mHeight, 0.1f, 100.0f);
