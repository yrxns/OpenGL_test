...
int main() {
  ...
  Shader ourShader("../examples/18_light_scene/shader/vertex.glsl", "../examples/18_light_scene/shader/fragment.glsl");
  Shader lightCubeShader("../examples/18_light_scene/shader/light_vert.glsl", "../examples/18_light_scene/shader/light_frag.glsl");
