...
int main() {
  ...
  Shader ourShader("../examples/21_light_map/shader/vertex.glsl", "../examples/21_light_map/shader/fragment.glsl");
  Shader lightCubeShader("../examples/21_light_map/shader/light_vert.glsl", "../examples/21_light_map/shader/light_frag.glsl");
...
/*******************************************************************/
    ...
    // 设置光照属性
    ourShader.setVector3("light.ambient", 0.5f, 0.5f, 0.5f);
    ourShader.setVector3("light.diffuse", 0.5f, 0.5f, 0.5f);
