...
int main() {
  ...
  Shader ourShader("../examples/22_light_map_exercise/shader/vertex.glsl", "../examples/22_light_map_exercise/shader/fragment.glsl");
  Shader lightCubeShader("../examples/22_light_map_exercise/shader/light_vert.glsl", "../examples/22_light_map_exercise/shader/light_frag.glsl");
