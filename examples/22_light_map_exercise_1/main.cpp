...
int main() {
  ...
  Shader ourShader("../examples/22_light_map_exercise_1/shader/vertex.glsl", "../examples/22_light_map_exercise_1/shader/fragment.glsl");
  Shader lightCubeShader("../examples/22_light_map_exercise_1/shader/light_vert.glsl", "../examples/22_light_map_exercise_1/shader/light_frag.glsl");
