...
int main() {
  ...
  Shader ourShader("../examples/22_light_map_exercise_2/shader/vertex.glsl", "../examples/22_light_map_exercise_2/shader/fragment.glsl");
  Shader lightCubeShader("../examples/22_light_map_exercise_2/shader/light_vert.glsl", "../examples/22_light_map_exercise_2/shader/light_frag.glsl");

  Texture_load texture1("../assets/container2.png", 0, GL_LINEAR, GL_LINEAR, GL_REPEAT, GL_REPEAT);
  Texture_load texture2("../assets/lighting_maps_specular_color.png", 1, GL_LINEAR, GL_LINEAR, GL_REPEAT, GL_REPEAT);
