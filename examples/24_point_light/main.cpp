...
int main() {
  ...
  Shader ourShader("../examples/24_point_light/shader/vertex.glsl", "../examples/24_point_light/shader/fragment.glsl");
  Shader lightCubeShader("../examples/24_point_light/shader/light_vert.glsl", "../examples/24_point_light/shader/light_frag.glsl");
  ...
  ourShader.setFloat("light.quadratic", 0.07f);
