...
int main() {
  ...
  Shader ourShader("../examples/25_spot_light_1/shader/vertex.glsl", "../examples/25_spot_light_1/shader/fragment.glsl");
  Shader lightCubeShader("../examples/25_spot_light_1/shader/light_vert.glsl", "../examples/25_spot_light_1/shader/light_frag.glsl");
  ...
  gl_app->rendering([&](){
    ...
    ImGui::SliderFloat("light.outerCutOff", &outerCutOff, 0.0f, 130.0f);
...
/*******************************************************************/
    ...
    ourShader.setFloat("light.outerCutOff", glm::cos(glm::radians(outerCutOff)));
