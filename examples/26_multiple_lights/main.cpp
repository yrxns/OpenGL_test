...
int main() {
  ...
  Shader ourShader("../examples/26_multiple_lights/shader/vertex.glsl", "../examples/26_multiple_lights/shader/fragment.glsl");
  Shader lightCubeShader("../examples/26_multiple_lights/shader/light_vert.glsl", "../examples/26_multiple_lights/shader/light_frag.glsl");
...
/*******************************************************************/
    ...
    ourShader.setVector3("dirLight.ambient", 0.05f, 0.05f, 0.05f);
