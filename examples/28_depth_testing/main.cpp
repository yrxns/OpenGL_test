...
int main() {
  ...
  Shader ourShader("../examples/28_depth_testing/shader/vertex.glsl", "../examples/28_depth_testing/shader/fragment.glsl");
  // Shader lightCubeShader("../examples/28_depth_testing/shader/light_vert.glsl", "../examples/28_depth_testing/shader/light_frag.glsl");
