...
int main() {
  ...
  Shader ourShader("../examples/30_blending_1/shader/vertex.glsl", "../examples/30_blending_1/shader/fragment.glsl");
  // Shader shaderSingleColor("../examples/30_blending_1/shader/stencil_vert.glsl", "../examples/30_blending_1/shader/stencil_frag.glsl");
