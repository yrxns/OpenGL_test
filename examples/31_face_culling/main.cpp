...
int main() {
  ...
  Shader ourShader("../examples/31_face_culling/shader/vertex.glsl", "../examples/31_face_culling/shader/fragment.glsl");
  // Shader shaderSingleColor("../examples/31_face_culling/shader/stencil_vert.glsl", "../examples/31_face_culling/shader/stencil_frag.glsl");
  ...
  Texture_load texture3("../assets/window.png", 2, GL_LINEAR, GL_LINEAR, GL_REPEAT, GL_REPEAT);
...
/*******************************************************************/
    ...
    {
        float distance = glm::length(cameraNS::camera->mPosition - windows[i]);
