...
int main() {
  ...
  Shader ourShader("../examples/32_frame_buffers/shader/vertex.glsl", "../examples/32_frame_buffers/shader/fragment.glsl");
  Shader screenShader("../examples/32_frame_buffers/shader/framebuffers_vert.glsl", "../examples/32_frame_buffers/shader/framebuffers_frag.glsl");
