...
int main() {
  ...
  Shader ourShader("../examples/32_frame_buffers_1/shader/vertex.glsl", "../examples/32_frame_buffers_1/shader/fragment.glsl");
  Shader screenShader("../examples/32_frame_buffers_1/shader/framebuffers_vert.glsl", "../examples/32_frame_buffers_1/shader/framebuffers_frag.glsl");
