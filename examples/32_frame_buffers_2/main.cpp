...
int main() {
  ...
  Shader ourShader("../examples/32_frame_buffers_2/shader/vertex.glsl", "../examples/32_frame_buffers_2/shader/fragment.glsl");
  Shader screenShader("../examples/32_frame_buffers_2/shader/framebuffers_vert.glsl", "../examples/32_frame_buffers_2/shader/framebuffers_frag.glsl");
