...
int main() {
  ...
  Shader ourShader("../examples/32_frame_buffers_3/shader/vertex.glsl", "../examples/32_frame_buffers_3/shader/fragment.glsl");
  Shader screenShader("../examples/32_frame_buffers_3/shader/framebuffers_vert.glsl", "../examples/32_frame_buffers_3/shader/framebuffers_frag.glsl");
