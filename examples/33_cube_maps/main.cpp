...
int main() {
  ...
  Shader ourShader("../examples/33_cube_maps/shader/vertex.glsl", "../examples/33_cube_maps/shader/fragment.glsl");
  Shader screenShader("../examples/33_cube_maps/shader/framebuffers_vert.glsl", "../examples/33_cube_maps/shader/framebuffers_frag.glsl");
