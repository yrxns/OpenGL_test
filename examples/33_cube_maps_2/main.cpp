...
int main() {
  ...
  Shader ourShader("../examples/33_cube_maps_2/shader/vertex.glsl", "../examples/33_cube_maps_2/shader/fragment.glsl");
  Shader skyboxShader("../examples/33_cube_maps_2/shader/skybox_vert.glsl", "../examples/33_cube_maps_2/shader/skybox_frag.glsl");
