...
int main() {
  ...
  Shader ourShader("../examples/33_cube_maps_4/shader/vertex.glsl", "../examples/33_cube_maps_4/shader/fragment.glsl");
  Shader skyboxShader("../examples/33_cube_maps_4/shader/skybox_vert.glsl", "../examples/33_cube_maps_4/shader/skybox_frag.glsl");
