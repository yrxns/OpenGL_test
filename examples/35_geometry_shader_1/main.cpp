...
int main() {
  ...
  Shader ourShader("../examples/35_geometry_shader_1/shader/vertex.glsl", "../examples/35_geometry_shader_1/shader/fragment.glsl", "../examples/35_geometry_shader_1/shader/geometry.glsl");
